    ...
    <section className="py-14 md:py-20 bg-gray-50 px-2 lg:px-0">
      <div className="overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 max-w-5xl mx-auto px-4 md:px-6 items-end">
          {/* Mission — slides in from left, tilted on desktop */}
          <FadeIn
            direction="left"
            amount={0.2}
            className="rounded-2xl p-7 md:p-10 flex flex-col gap-4 md:gap-5 origin-bottom md:-rotate-3 md:hover:rotate-0 transition-[transform] duration-300"
          ...
          {/* Vision — slides in from right, tilted on desktop */}
          <FadeIn
            direction="right"
            amount={0.2}
            className="rounded-2xl p-7 md:p-10 flex flex-col gap-4 md:gap-5 bg-white border border-gray-200 origin-bottom md:rotate-3 md:hover:rotate-0 transition-[transform] duration-300"
          >
