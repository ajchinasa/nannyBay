...
const NannyPackages = () => {
  const [selectedTier, setSelectedTier] = useState(
    nannyPackages[0]?.tier || "",
  );

  const activePkg =
    nannyPackages.find((pkg) => pkg.tier === selectedTier) || nannyPackages[0];
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 mt-1 font-normal leading-relaxed">
                Experienced, thoroughly background-checked nannies for dedicated
                home support.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-7 bg-[#0E1420] border border-slate-800 rounded-2xl p-4 flex flex-col justify-between">
              ...
              <div className="pt-3 border-t border-slate-800/80 flex justify-center">
                <CTAButton label="Book a Nanny" serviceId="nanny-services" />
              </div>
            </div>
          </div>
        </div>
